...
<template>
    ...
    <div class="bg-gradient-to-b from-[#ff7931] to-[#c63804] min-h-screen w-full">
        ...
        <Header pageTitle="Come nasce un beat - 23.05.25 - ore 17 - Fondazione Caritro"
            linkLable="Talk - 22.05.25 - Piazza Fiera" linkUrl="/scorrendo-tra-le-generazioni-05" :imageSrc="fotoAndry"
        ...
        <div class="pt-24 pb-12 lg:pt-28 lg:pb-32 text-white">
            ...
            <div class="max-w-[1920px] px-8 lg:px-36">
                ...
                <div class="lg:pb-[35px] pt-[37px]">
                    <p class="lg:w-[550px] lg:text-xl">Scopri il processo creativo dietro la produzione musicale,
                        guidato da un <strong class="black">ospite speciale</strong> che mostrerà ogni passo, dall'idea
                        al risultato finale.</p>
                </div>
                <div class="grid grid-cols-2 gap-4 md:hidden">
                    <div class="flex justify-center items-center">
                        <svg class="w-auto" viewBox="0 0 155 191" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M22.0001 1.99994C9.0001 10.9999 1.00033 37.4999 2.5002 55.9999C4.00006 74.4999 23.5003 101 46.0002 101C68.5001 101 84.0002 86.0064 95.5002 81.4999C107 76.9935 116.411 81.7106 119.487 89.7715C123.849 103.582 111.205 112.465 100.211 117.588C86.9239 123.895 71.1654 126.888 58.2561 134.615C36.1942 148.439 47.0001 176.611 68.5001 179.611C90.0001 182.611 128 177.582 148.5 169.611"
                                stroke="#31006B" stroke-width="3" stroke-miterlimit="10" stroke-linecap="round" />
                            <path d="M126 161.955L151.6 169.15L132.968 188.994" stroke="#31006B" stroke-width="3"
                                stroke-miterlimit="10" stroke-linecap="round" />
                        </svg>
                    </div>
                    <div class="flex justify-center items-center">
                        <img class="w-[250px] pt-12" alt="foto di Andry the Hitmaker"
                            src="../assets/ospiti/maggio/andry-new.png">
                    </div>
                    <div class="col-span-2 text-right pt-6 text-white">
                        <p class="uppercase text-2xl whitespace-nowrap">Andry the Hitmaker</p>
                        <p>Produttore musicale <br>
                            <a class="underline"
                                href="https://www.instagram.com/andrythehitmaker/">@andrythehitmaker</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class=" text-white flex flex-col items-center">
            <div class="max-w-[1920px] w-full  px-8 pt-24 mb-12 lg:pt-28 lg:px-36">
                ...
                <ul class="grid grid-cols-1 lg:grid-cols-2 lg:pl-16 gap-8">
                    ...
                    <li class="flex items-start space-x-4">
                        <img class="w-[28px] lg:w-[38px]" src="../assets/icone-maggio/calendario-viola.png"
                            alt="Icona calendario">
                        <p class="text-2xl lg:text-3xl">23.05.2025</p>
                    </li>

                    <li class="flex items-start space-x-4">
                        <img class="w-[28px] lg:w-[38px]" src="../assets/icone-maggio/orologio-viola.png"
                            alt="Icona orologio">
                        <p class="text-2xl lg:text-3xl">17 - 19</p>
                    </li>

                    <li class="flex items-start space-x-4">
                        <img class="w-[28px] lg:w-[38px]" src="../assets/icone-maggio/posizione-viola.png"
                            alt="icona luogo">
                    ...
                    <li class="flex items-start space-x-4">
                        <a class="" href="https://www.eventbrite.it/e/1096506202569?aff=oddtdtcreator"><img
                                class="w-[30px] lg:w-[38px] -mt-2" src="../assets/icone-maggio/biglietto-viola.png"
                                alt="Icona biglietto cartaceo"></a>
            ...
            <div class="w-full h-96">
                ...
                <l-map ref="mapRef" v-model:zoom="zoom" v-model:center="center" @ready="onMapReady">
