        ...
        <div class="text-white flex flex-col items-center">
            <div class="max-w-[1920px] w-full pt-24 pb-12 lg:pt-28 lg:pb-32 px-8 lg:px-36">
                ...
                <p class="text-xl font-regular leading-7 lg:pl-28">
                    Il secondo appuntamento di <strong>SWIPE</strong> entra nel cuore della musica. Partendo dalle
                    professioni che operano in questo mondo, andremo a parlare di <strong>storie, cambiamenti e
                        dinamiche</strong> accadute negli ultimi anni. Un dialogo tra generazioni, background e generi
                    diversi che porterà a <strong>conoscere</strong> più a fondo <strong>il linguaggio universale della
                        musica!</strong>
                </p>
